...
insert into job_vacancy (employer_id, name, description, amount) values (1, 'vaga para pizzaiolo', 'buscamos pizzaiolos para trabalhar aos finais de semana na pizzaria', 1);
...
insert into job_vacancy (employer_id, name, description, amount) values (1, 'vaga para entregador', 'buscamos entregadores para entregar pizzas todas as noites', 3);
